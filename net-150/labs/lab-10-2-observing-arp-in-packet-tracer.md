...
10. **SUBMIT (2 Points) Screenshot showing successful ping between PC0 and PC3**
    1.
        ...
        <figure><img src="../../.gitbook/assets/image (4) (1) (1).png" alt=""><figcaption><p>Successful ping from PC0 to PC3.</p></figcaption></figure>
...
12. Now, inspect the configuration of the Switch using the steps outlined above in step 6 for the CLI and show mac-address-table.
    ...
    *
        ...
        <figure><img src="../../.gitbook/assets/image (6) (1) (1).png" alt=""><figcaption><p>Screenshot of <code>show mac-address-table</code> command on the switch</p></figcaption></figure>
13. **SUBMIT: Screenshot of Packet Tracer showing all 4 PC's connected to switch (1 Points)**
    1.

        <figure><img src="../../.gitbook/assets/image (7) (1).png" alt=""><figcaption><p>Screenshot of PCs connected to Switch</p></figcaption></figure>
